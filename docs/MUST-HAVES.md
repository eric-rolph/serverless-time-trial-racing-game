...
| 5 | FFB in native client (DirectInput constant force, ffb.toml) | ✅ awaiting rig test |
...
| 6e | Physics wave 3: unsprung mass (quarter-car), kinematic camber/toe curves + camber thrust, inertia tensor from mass layout (docs/SUSPENSION.md) | ✅ |
