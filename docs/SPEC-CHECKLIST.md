...
| 15 | **Brush tire model** (docs/TIRE-MODEL.md): N=16 bristle patch, parabolic pressure, static/kinetic breakaway, EMERGENT pneumatic trail (20.2mm@1° → 0@15°, peak α 6.65°, peak 1.023·μFz, −10.2%@15°), 2-node thermal (cold=0.85 grip), combined-slip budget; SAT/FFB from emergent trail. Steering invert+rotation settings. Track archetypes (hairpin+chicane), width choreography, guaranteed straight | all 5 gates green; live e2e accepted 65.427s on new track 8de1eee4, fresh leaderboard |
