...
EXPORTS=_sim_abi_version,_sim_alloc,_sim_load_track,_sim_reset,_sim_step,_sim_replay,_sim_state_ptr,_sim_state_size,_sim_state_hash_lo,_sim_state_hash_hi,_sim_lap_time_ticks
